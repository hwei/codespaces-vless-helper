...
- Add best-effort public port visibility setup for the VLESS and helper ports using GitHub Codespaces tooling, with clear fallback instructions when automation is blocked by authentication or organization policy.
...
- Uses GitHub CLI or Codespaces port forwarding features to attempt public port visibility setup.
